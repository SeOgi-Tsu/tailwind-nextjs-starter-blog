    ...
    <>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative space-y-8 pt-16 pb-12 md:space-y-10 md:pt-20 md:pb-16">
          ...
          <div className="space-y-6 text-center">
            {/* Logo/Brand */}
            <div className="inline-flex items-center space-x-2 rounded-full border border-gray-200/50 bg-white/80 px-4 py-2 shadow-sm backdrop-blur-sm dark:border-gray-700/50 dark:bg-gray-800/80">
            ...
            {/* 副标题 */}
            <p className="mx-auto max-w-3xl text-lg leading-8 text-gray-600 md:text-xl dark:text-gray-300">
              🚀 每日更新的 AI 教程博客，专注于
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-4">
              {[
                ...
                <div
                  key={index}
                  className={`inline-flex items-center space-x-1 rounded-full bg-gradient-to-r px-3 py-1.5 text-sm font-medium text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl ${tag.color}`}
                >
                  <span>{tag.icon}</span>
                  <span>{tag.text}</span>
                </div>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-6 pt-12 pb-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className="rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-500 dark:bg-gray-800 dark:text-gray-400">
              Daily Update
            </span>
          </div>

          {/* 学习进度提示 */}
          <div className="rounded-2xl border border-blue-200/50 bg-gradient-to-r from-blue-50 to-purple-50 p-6 dark:border-blue-700/50 dark:from-blue-900/20 dark:to-purple-900/20">
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-purple-500 text-xl text-white">
                  📚
                </div>
              </div>
        ...
        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
          {!posts.length && (
            <div className="py-24 text-center">
              <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-purple-500">
      ...
      {posts.length > MAX_DISPLAY && (
        <div className="flex justify-center pt-8">
          <Link
            href="/blog"
            className="inline-flex items-center space-x-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 font-medium text-white shadow-lg transition-all duration-300 hover:scale-105 hover:from-blue-700 hover:to-purple-700 hover:shadow-xl"
          >
            <span>查看所有教程</span>
      ...
      {siteMetadata.newsletter?.provider && (
        <div className="mt-16 border-t border-gray-200 pt-12 dark:border-gray-700">
          <div className="rounded-3xl bg-gradient-to-br from-blue-50 to-purple-50 p-8 md:p-12 dark:from-blue-900/20 dark:to-purple-900/20">
            <div className="space-y-6 text-center">
