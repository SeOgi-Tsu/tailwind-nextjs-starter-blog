          ...
          <div className="space-y-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-4">
              {[
                ...
                <div
                  key={index}
                  className={`inline-flex items-center space-x-1 bg-gradient-to-r px-3 py-1.5 ${tag.color} rounded-full text-sm font-medium text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl`}
                >
                  <span>{tag.icon}</span>
                  <span>{tag.text}</span>
                </div>
